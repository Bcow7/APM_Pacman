...
#define PACMAC_NO_MOVE 			(0x10 + CHAR_BASE)
#define PACMAC_GO_RIGHT 		(0x11 + CHAR_BASE)
#define PACMAC_GO_UP 			(0x12 + CHAR_BASE)
#define PACMAC_GO_LEFT 			(0x13 + CHAR_BASE)
#define PACMAC_GO_DOWN 			(0x14 + CHAR_BASE)
