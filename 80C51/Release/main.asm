...
; This file was generated Fri Jan 22 14:38:58 2016
;--------------------------------------------------------
	.module main
...
;------------------------------------------------------------
;	../main.c:14: void pause(unsigned int t) {
;	-----------------------------------------
;	 function pause
;	-----------------------------------------
_pause:
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../main.c:19: void initialize() {
;	-----------------------------------------
;	 function initialize
;	-----------------------------------------
_initialize:
;	../main.c:20: STDIO_initialize();
	lcall	_STDIO_initialize
;	../main.c:21: GMB_initialize();
	ljmp	_GMB_initialize
;------------------------------------------------------------
;Allocation info for local variables in function 'play'
;------------------------------------------------------------
;pacman                    Allocated with name '_play_pacman_1_1'
...
;	-----------------------------------------
_play:
;	../main.c:26: Pacman pacman = {MOVES_RIGHT, {10, 10}, ALIVE, 5};
	mov	_play_pacman_1_1,#0x03
	mov	(_play_pacman_1_1 + 0x0001),#0x0A
	mov	(_play_pacman_1_1 + 0x0002),#0x0A
	mov	(_play_pacman_1_1 + 0x0003),#0x00
	mov	(_play_pacman_1_1 + 0x0004),#0x05
;	../main.c:27: unsigned char *keyboard = (unsigned char __xdata *) 0x3000;
	mov	r2,#0x00
	mov	r3,#0x30
	mov	r4,#0x00
;	../main.c:30: GMB_draw(PACMAN_LIMIT_X0, PACMAN_LIMIT_Y0, PACMAN_LIMIT_X1, PACMAN_LIMIT_Y1);
...
;	../main.c:37: pause(20000);
	mov	dptr,#0x4E20
	lcall	_pause
	pop	ar4
	pop	ar3
	pop	ar2
;	../main.c:38: } while (pacman.status != DEAD);
	mov	a,#0x02
	cjne	a,(_play_pacman_1_1 + 0x0003),00101$
